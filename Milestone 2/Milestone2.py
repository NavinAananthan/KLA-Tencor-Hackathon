...
def write_file(coordinates):
    with open('E:\KLA Hackathon 2023\Milestone_Input\Milestone 2\output2.txt','a',newline='') as file:
        file.write('boundary \n')
        file.write('layer 1 \n')
...
def Input_file():
    data=[]
    file=open('E:\KLA Hackathon 2023\Milestone_Input\Milestone 2\Source.txt','r')
    for line in file: 
        word=line.split()
        data.append(word)
    return data
...
def validattion_file():
    data=[]
    valid_corodinates=[]
    file=open('E:\KLA Hackathon 2023\Milestone_Input\Milestone 2\POI.txt','r')
    for line in file: 
        word=line.split()
        data.append(word)
